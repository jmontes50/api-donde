...
async function create(req, res, next) {
  try {
    ...
    const restaurant = await service.create({ name, description, address, phone, image_url, opening_time, closing_time, lat, lng, district_id, category_id });
...
async function update(req, res, next) {
  try {
    ...
    const restaurant = await service.update(id, { name, description, address, phone, image_url, opening_time, closing_time, lat, lng, district_id, category_id });
    res.json({ data: restaurant });
  } catch (err) {
    next(err);
  }
